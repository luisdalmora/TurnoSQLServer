...
<head>
    ...
    <style>
        /* Estilo para manter quebras de linha no conteúdo do script exibido na lista */
        .script-content-display {
            white-space: pre-wrap;
            word-wrap: break-word;
            font-family: monospace; /* Melhor para visualização de código */
            background-color: #f8f9fa;
            border: 1px solid #dee2e6;
            padding: 10px;
            border-radius: 0.25rem;
            max-height: 200px; /* Limita altura para não poluir a lista */
            overflow-y: auto;
        }
    </style>
</head>
<body class="bg-gray-100 font-poppins text-gray-700">
    <div class="flex h-screen overflow-hidden">
        <aside class="w-64 bg-gradient-to-b from-blue-800 to-blue-700 text-indigo-100 flex flex-col flex-shrink-0">
            ...
            <nav class="flex-grow p-2 space-y-1">
                ...
                <a href="gerenciar_scripts.php" class="flex items-center px-3 py-2.5 rounded-lg bg-blue-600 text-white font-medium text-sm">
        ...
        <div class="flex-grow flex flex-col overflow-y-auto">
            <header class="h-16 bg-white shadow-sm flex items-center justify-between px-4 md:px-6 flex-shrink-0">
                <div class="flex items-center">
                    <i data-lucide="file-code-2" class="w-6 h-6 md:w-7 md:h-7 mr-2 md:mr-3 text-blue-600"></i>
                    <h1 class="text-md md:text-lg font-semibold text-gray-800">Gerenciar Scripts</h1>
                </div>
                ...
                <section class="bg-white p-4 md:p-6 rounded-lg shadow">
                    ...
                    <form id="form-novo-script">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="script-conteudo" name="conteudo" rows="8" class="form-textarea block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required></textarea>
                        </div>
                        <div>
    ...
    <script src="src/js/modules/utils.js" type="module"></script> <script src="src/js/gerenciar_scripts.js" type="module"></script>
    <script>
