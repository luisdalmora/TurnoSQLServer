...
<head>
    ...
    <style>
        #senhaGeradaDisplay { font-family: "Roboto Mono", monospace; }
        /* Toastr dark mode styles */
        html.dark .toast-success { background-color: #059669 !important; } /* green-700 */
        html.dark .toast-error { background-color: #dc2626 !important; } /* red-600 */
        html.dark .toast-info { background-color: #2563eb !important; } /* blue-600 */
        html.dark .toast-warning { background-color: #f59e0b !important; color: #1f2937 !important; } /* amber-500, text-gray-800 */
    ...
    <div class="flex h-screen overflow-hidden">
        <aside class="w-64 bg-gradient-to-b from-blue-800 to-blue-700 text-indigo-100 flex flex-col flex-shrink-0 dark:from-gray-800 dark:to-gray-900 transition-colors duration-300">
            ...
            <nav class="flex-grow p-2 space-y-1">
                ...
                <a href="gerador_senhas.php" class="flex items-center px-3 py-2.5 rounded-lg bg-blue-600 text-white font-medium text-sm dark:bg-blue-700 dark:hover:bg-blue-600"> <i data-lucide="key-round" class="w-5 h-5 mr-3"></i> Gerador de Senhas
                </a>
        ...
        <div class="flex-grow flex flex-col overflow-y-auto">
            <header class="h-16 bg-white shadow-sm flex items-center justify-between px-4 md:px-6 flex-shrink-0 dark:bg-gray-800 dark:border-b dark:border-gray-700 transition-colors duration-300">
                <div class="flex items-center">
                    <i data-lucide="key-round" class="w-6 h-6 md:w-7 md:h-7 mr-2 md:mr-3 text-blue-600 dark:text-blue-400"></i>
            ...
            <main class="flex-grow p-4 md:p-6 flex items-center justify-center bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
                <section class="bg-white p-6 md:p-8 rounded-lg shadow-xl w-full max-w-xs text-center dark:bg-gray-800 dark:border dark:border-gray-700 transition-colors duration-300">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-6">Gerar Senha</h2>

                    <button id="senhaPay" class="w-full mb-3 flex items-center justify-center px-4 py-2.5 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out dark:bg-blue-700 dark:hover:bg-blue-600 dark:focus:ring-offset-gray-800">
                        <i data-lucide="credit-card" class="w-4 h-4 mr-2"></i> Senha Pay
                    </button>
                    <button id="senhaAutomacao" class="w-full mb-6 flex items-center justify-center px-4 py-2.5 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out dark:bg-blue-700 dark:hover:bg-blue-600 dark:focus:ring-offset-gray-800">
                        <i data-lucide="zap" class="w-4 h-4 mr-2"></i> Senha Automação
                    </button>

                    <div id="senhaGeradaDisplayContainer" class="mb-6 hidden py-4 bg-gray-50 dark:bg-gray-700 rounded-md">
